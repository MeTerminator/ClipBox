    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            data.forEach(function(item) {
				item.lrc = "https://api.injahow.cn/meting/?server=tencent&type=lrc&id=" + item.mid;
                html += `<div class="list-item" data-url="${item.url}" data-pic="${item.cover}" data-mid="${item.mid}" data-lrc="${item.lrc}">
